	...
	if($image !="")
		{
			...
			if($anh_hop_le=="yes")
			{
				...
				if($row[0]== 0)
				{
					...
					$chuoi = "INSERT INTO san_pham VALUES(NULL,'$_POST[txtThem_san_pham]' ,'$a' ,'$image','$brochure','$_POST[txtGia_sp]' ,'0','0','$_POST[cap_do]','$_POST[selTrangchu]','$_POST[txtXuat_xu]','$_POST[txtBao_hanh]','0903228633')";
					mysql_query($chuoi);
				}else
				{
