...
<?php
	...
	$chuoi = "SELECT *FROM quang_cao WHERE vi_tri ='truot_phai'";
...
<table id="table_quanly" border="1" width="700px">
	...
	<?php
		while($fetch = mysql_fetch_array($query))
		{
			...
			$link_sua = "?thamso=sua_quang_cao_truot_phai&id=$fetch[id]&page=$_GET[page]";
			$link_xoa = "?thamso=xoa_quang_cao_truot_phai&id=$fetch[id]";
