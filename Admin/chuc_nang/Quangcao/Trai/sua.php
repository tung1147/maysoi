...
<CENTER>
	<table width="500px"  bgcolor="#99CCCC" style="margin-top: 6px" >
		...
		<table width="500px" border="1" style="margin-top: 0px; margin-bottom: 6px">
			...
			<tr>
				<td>R&#7897;ng:</td>
				<td><input  type="text" name="txtRong" size="50px" value="<?php echo $fetch['rong']; ?>"></td>
			</tr>
			<tr>
				<td>Cao:</td>
				<td><input  type="text" name="txtCao" size="50px" value="<?php echo  $fetch['cao']; ?>"></td>
			</tr>
			<tr>
				<td colspan="2" align="center">
					<input  type="submit" name="sua_quang_cao_trai" value="S&#7917;a qu&#7843;ng c&#225;o tr&#225;i"/>
