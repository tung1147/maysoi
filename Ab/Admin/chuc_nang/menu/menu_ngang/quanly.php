...
/*$sd=20;
	...
	function menu_de_quy($id,$chuoi_menu){
		$sql ="SELECT *FROM menu WHERE vitri_menu='ngang' and thuoc_menu='$id' ORDER BY id";
	...
	$chuoi_menu ="";
	$sql = "SELECT * FROM menu WHERE vitri_menu='ngang' and thuoc_menu='' ORDER BY id";
	$relt = mysql_query($sql);
	...
	#tinh so trang
	$sql_1 = "SELECT COUNT(*) FROM menu WHERE vitri_menu='ngang'";
...
?>
<center>
	<table width="600px"   id="table_quanly" border="1">
		<tr>
			<td width="300px" ><font size="3px" color="#ff0000"><b>T&#234;n menu</b></font></td>
			<td width="150px"><font size="3px" color="#ff0000"><b>S&#7917;a </b></font></td>
			<td width="150px"><font size="3px" color="#ff0000"><b>Xo&#225;</b></font></td>
		</tr>
		<?php 
			/*while ($arry = mysql_fetch_array($rel)){
				$link_sua = "?thamso=sua_menu_ngang&id=$arry [id]&trang=$_GET[trang]";
				$link_xoa ="?thamso=xoa_menu_ngang&id=$arry [id]";
				$cap_menu = cap_menu($arry ['id']);
				$chuoi_kt="";
		...
		<tr>
			<td><a href="<?php echo $chuoi_kt; ?>" ><?php echo $tv_2 ['ten'] ;?> </a></td>
