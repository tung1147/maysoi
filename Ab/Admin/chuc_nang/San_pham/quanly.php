...
<table width="900px" id="table_quanly" border="1">
	<tr>
		<td width="150px" align="center"><font size="3px" color="#ff0000"><b>Hình ảnh</b></font></td>
		<td width="250px" align="center"><font size="3px" color="#ff0000"><b>Tiêu đề</b></font></td>
		<td width="345px" align="center"><font size="3px" color="#ff0000"><b>Nội dung</b></font></td>
		<td width="100px" align="center"><font size="3px" color="#ff0000"><b>S&#7917;a</b></font></td>
		<td width="100px" align="center"><font size="3px" color="#ff0000"><b>Xóa</b></font></td>
	</tr>
	<?php
		while($tv_2 = mysql_fetch_array($tv_1))
		{
			
			$link_hinh="../image/San_pham/$tv_2[hinh_anh]";
			...
			?>
				<tr>
					...
					<td align="center"><a href="<?php echo $link_xoa; ?>" >Xóa</a></td>
				</tr>
			<?php
		}
	?>
