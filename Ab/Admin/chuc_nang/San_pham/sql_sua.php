...
{		
	...
	if($anh_hop_le =="Yes")
	{
		...
		if($row == 0 or $image_trung =="Yes")
		{
			...
			#$noi_dung = thay_the_fckeditor($_POST['noidung']);
			$chuoi ="UPDATE san_pham SET ten = '$_POST[txtTen_san_pham]',noi_dung = '$noi_dung',hinh_anh ='$image',brochure='$file', gia = '$_POST[txtGia_sp]',trang_chu = '$_POST[selTrangchu]',xuat_xu = '$_POST[txtXuat_su]',bao_hanh = '$_POST[txtBao_hanh]' WHERE san_pham.id =$_GET[id] LIMIT 1";
			mysql_query($chuoi);
